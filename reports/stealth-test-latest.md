...
| Test | Status | Time |
|------|--------|------|
| `test_navigator_webdriver_false` | PASS | 3.85s |
...
| `test_screen_resolution_not_headless_default` | PASS | 0.46s |

## linux-amd64

**Result:** 22/22 passed in 8.0s

| Test | Status | Time |
|------|--------|------|
| `test_navigator_webdriver_false` | PASS | 5.85s |
...
| `test_canvas_noise_applied` | PASS | 1.68s |
...
| `test_screen_resolution_not_headless_default` | PASS | 0.18s |

## live-darwin-arm64

**Result:** 5/5 passed in 40.3s

| Test | Status | Time |
|------|--------|------|
| `test_device_and_browser_info` | PASS | 13.67s |
| `test_browserscan` | PASS | 9.60s |
| `test_fingerprintjs` | PASS | 7.05s |
| `test_recaptcha_v3` | PASS | 5.74s |
| `test_whatismybrowser` | PASS | 4.16s |

## live-linux-amd64

**Result:** 5/5 passed in 39.5s

| Test | Status | Time |
|------|--------|------|
| `test_device_and_browser_info` | PASS | 12.88s |
| `test_browserscan` | PASS | 9.81s |
| `test_fingerprintjs` | PASS | 6.93s |
| `test_recaptcha_v3` | PASS | 5.56s |
